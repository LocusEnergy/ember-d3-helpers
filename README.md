...
* [Shape helpers](#shape-helpers)
  - [`d3-arc`](#d3-arc-params-innerradius-outerradius-startangle-endangle)
  - [`d3-area`](#d3-area-xscale-yscale-xaccessor-yaccessor)
  - [`d3-line`](#d3-line-xscale-yscale-xaccessor-yaccessor)  
  - [`d3-pie`](#d3-pie)
